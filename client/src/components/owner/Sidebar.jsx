...
const Sidebar = () => {
  ...
  return (
    ...
    max-w-13 md:max-w-60 border-r border-borderColor text-sm"
    >
      <div className="group relative">
        <label htmlFor="image">
          <img className="h-9 md:h-14 md:w-14 rounded-full mx-auto"
            src={
              image
      ...
      <div className="w-full">
        {ownerMenuLinks.map((link, index) => (
          ...
          >
            ...
            h-8 rounded-lg right-0 absolute`}
            ></div>
          </NavLink>
        ))}
      </div>
