    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        >
          ...
          <span className="tex-sm text-white/80">/ day</span>
        </div>
      </div>
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-4 grid grid-cols-1-2 gap-y-2 text-gray-600">
          ...
          <div className="flex items-center text-sm text-muted-foreground">
            <img src={assets.fuel_icon} alt="carFuel" className="h-4 mr-2" />
