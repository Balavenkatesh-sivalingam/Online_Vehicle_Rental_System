  ...
  return (
    ...
    >
      ...
      <div
        ...
        max-sm:border-t border-borderC010r right-0 flex flex-col sm:flex-row
        items-start sm:items-center gap-4 sm:gap-8 max-sm:p-4 transition-all
        duration-300 z-50 ${
          location.pathname === "/" ? "bg-light" : "bg-white"
        }  ${open ? "max-sm:translate-0" : "max-sm:translate-x-full"}`}
      >
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
          ...
          >
            {isOwner ? "Admin Dashboard" : "List Vehicles"}
          </button>
          <button
            onClick={() => {
